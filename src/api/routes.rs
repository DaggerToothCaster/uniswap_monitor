...
pub fn create_router(state: ApiState) -> Router {
    Router::new()
        ...
        .route("/api/pairs/:chain_id/:address", get(handlers::get_pair_detail))
        .route("/api/pairs/:chain_id/:address/kline", get(handlers::get_kline))
        .route("/api/pairs/:chain_id/:address/timeseries", get(handlers::get_timeseries))
        ...
        .route("/api/pairs/:chain_id/:address/stats", get(handlers::get_pair_stats))
        ...
        .route("/api/tokens/:chain_id/:address", get(handlers::get_token_detail))
        
        // Wallet routes
        .route("/api/wallets/:address/transactions", get(handlers::get_wallet_transactions))
        .route("/api/wallets/:address/stats", get(handlers::get_wallet_stats))
        .route("/api/wallets/:address/portfolio", get(handlers::get_wallet_portfolio))
        .route("/api/wallets/:address/pnl", get(handlers::get_wallet_pnl))
        ...
        .route("/api/metadata/tokens/:chain_id/:address/verify", 
               post(handlers::verify_token_metadata))
        
        // Status routes
        .route("/api/status/blocks", get(handlers::get_processing_status))
        .route("/api/status/blocks/detailed", get(handlers::get_detailed_processing_status))
